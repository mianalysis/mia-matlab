...
/**
 * The <code>StackMatcher</code> class provides a Java interface to MATLAB functions. 
 * The interface is compiled from the following files:
 * <pre>
 *  F:\\Java Projects\\mia-matlab\\MATLAB\\StackMatcher\\matchImageInStack.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>StackMatcher</code> 
 * instance when it is no longer needed to ensure that native resources allocated by this 
 * class are properly freed.
 * @version 0.0
 */
public class StackMatcher extends MWComponentInstance<StackMatcher> implements Serializable
{
    /**
     ...
     */
    private StackMatcher (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(StackMatcher.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>StackMatcher</code> class.
     * @throws MWException An error has occurred during the function call.
     */
    public StackMatcher() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #StackMatcher(MWComponentOptions componentOptions)}.
     ...
     */
    @Deprecated
    public StackMatcher(String pathToComponent) throws MWException
    {
        this(MIA_MATLAB_CoreMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>StackMatcher</code> class. Use this 
     * constructor to specify the options required to instantiate this component.  The 
     * options will be specific to the instance of this component being created.
     * @param componentOptions Options specific to the component.
     * @throws MWException An error has occurred during the function call.
     */
    public StackMatcher(MWComponentOptions componentOptions) throws MWException
    {
